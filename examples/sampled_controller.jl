...
using Plots
p_phi = plot(sol.t[1:25], sol[1, 1:25], label = "\$\\phi\$ (ODE)")
plot!(p_phi, range(0, max_time, length = n_steps)[1:100], phi_list[1:100], label = "\$\\phi\$ (Real data)")
display(p_phi)
